...
import DevPic from "../assets/about.jpg";
        ...
        <div className="flex flex-wrap">
            <div className=" w-full lg:w-1/2">
                <div className=" flex flex-col
                 items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible"
                    className="pb-10 text-3xl font-thin tracking-tight lg:mt-16 lg:text-6xl">HariHaraPudhran</motion.h1>
                    <motion.span
            ...
            <div className="w-full lg:w-1/2 lg:p-8">
                <div className="flex justify-center">
                    ...
                    className="h-96 w-96 rounded-3xl" src={DevPic} alt="Hari" />
                </div>
            </div>
        </div>
    </div>
